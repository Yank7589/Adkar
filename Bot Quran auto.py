...
Token = input("6561779740:AAE66YBfrZIKebrpAf_h-o5zxGFLWt31hO0")
bot = TeleBot(Token)
user_ch = input("Algeria457") #معرف قناة النشر بدون @
key , dev = Mk() , Mk() 
dev.add(btn(text=" • المطور • ",url="t.me/kotigori") )
key.add(btn(text="• تفعيل النشر التلقائي 🔛 •",callback_data="run"))
key.add(btn(text="• قناة النشر التلقائي  •", callback_data="ch")) 
key.add(btn(text=" • المطور • ",url="t.me/kotigori"))
